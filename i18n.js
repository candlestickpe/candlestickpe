(function () {
  ...
  const ecoworldOverview = {
    ...
    ko: [
      ...
      "인수 Value: Pre 약 500억원",
    ],
  };

  const nplBusiness = {
    en: [
      "Real estate NPL investment project backed by collateral assets in Yeoksam.",
    ...
    ko: [
      "역삼 소재 부동산 담보자산을 기반으로 한 NPL 투자 프로젝트임.",
  ...
  const nplOverview = {
    en: [
      "Designed an NPL investment structure for Yeoksam real estate.",
  ...
  const portfolioDetailFields = {
    ...
    peoplebio: {
      en: [
        ...
        ["Sector", "Pharmaceuticals / Bio"],
        ["Company Website", "https://peoplebio.net"],
      ],
      ko: [
        ["프로젝트명", "Project PeopleBio"],
        ["회사 / 투자대상", "주식회사 피플바이오 / PeopleBio Co., Ltd."],
        ["섹터", "제약/바이오"],
        ["회사 홈페이지", "https://peoplebio.net"],
      ],
    },
    edge: {
      en: [
  ...
  const pages = {
    ...
    philosophy: {
      en: {
        ...
        body: [
          "Candlestick PE believes that investing is about more than deploying and realizing capital. It is a journey built on trust—managing entrusted capital responsibly while helping companies and investors grow together.",
          "We believe that trust comes before capital.",
          "Honest and transparent decision-making, disciplined investment judgment, responsible stewardship, and long-term partnership are the core principles that guide Candlestick PE throughout the investment process.",
          "The name Candlestick reflects our aspiration to be a quiet light along the path ahead—recognizing the potential of companies and helping investors and partners find the way forward.",
          "We view the capital entrusted to us by investors not simply as a financial asset, but as capital to be managed responsibly with the trust placed in us.",
          "Our investment approach is to help good companies become stronger businesses and create a virtuous cycle in which the benefits of growth are shared among investors, companies, employees, and other stakeholders.",
          "Guided by integrity, responsibility, disciplined investing, and a commitment to long-term value creation, Candlestick PE seeks to remain a trusted investment partner, helping illuminate the path forward for investors and companies alike.",
        ],
      },
      ko: {
        ...
        body: [
          ...
          "정직하고 투명한 의사결정, 원칙 있는 투자 판단, 책임 있는 운용, 그리고 장기적인 파트너십은\n캔들스틱PE가 모든 투자 과정에서 지키고자 하는 기본 원칙입니다.",
          "캔들스틱이라는 이름에는\n어두운 길 위에서 조용히 방향을 비추는 작은 빛처럼,\n기업의 가능성을 발견하고 투자자와 파트너들이 함께 나아갈 방향을 비추겠다는 뜻이 담겨 있습니다.",
          "우리는 투자자로부터 맡겨진 자본을 단순한 금융자산이 아니라,\n신뢰를 바탕으로 책임 있게 관리해야 할 자본으로 바라봅니다.",
          "좋은 기업이 더 견실한 기업으로 성장하도록 돕고,\n그 성장의 결실이 투자자, 기업, 임직원과 이해관계자 모두에게 돌아가는 선순환을 만드는 것이\n캔들스틱PE가 추구하는 투자입니다.",
          "캔들스틱PE는 앞으로도\n정직, 책임, 원칙 있는 투자, 장기적 가치 창출이라는 기준 아래\n투자자와 기업이 함께 나아갈 방향을 비추는\n신뢰받는 투자 파트너가 되겠습니다.",
        ],
      },
    },
          ...
          "en": {
                ...
                "rows": [
                      ...
                      },
                      {
                            "alt": "Project NPL II",
                            "logoText": "NPL",
                            "title": "Project NPL II",
                            "business": nplIIBusiness.en,
                            "overview": nplIIOverview.en
                      },
                      {
                            "image": "PP.png",
                            "alt": "PeopleBio",
          ...
          "ko": {
                ...
                "rows": [
                      ...
                      },
                      {
                            ...
                            "logoText": "NPL",
                            "title": "Project NPL II",
                            "business": nplIIBusiness.ko,
                            "overview": nplIIOverview.ko
                      },
                      {
                            "image": "PP.png",
                            "alt": "PeopleBio",
    ...
    esg: {
      en: {
        ...
        esgLead: [
          "Candlestick Co., Ltd. (“Candlestick” or the “Company”) recognizes that the sustainable growth and long-term value creation of the companies in which we invest are closely aligned with the interests of investors. Accordingly, the Company seeks to consider environmental, social, and governance factors throughout the investment lifecycle, including investment review, decision-making, post-investment management, and exit.",
          "Candlestick evaluates not only financial performance but also management transparency, internal controls, stakeholder relationships, legal and regulatory compliance, and environmental and social risks. Following an investment, the Company works with portfolio companies to identify improvement priorities appropriate to their growth stage and business characteristics and, where appropriate, engages external experts to develop practical value-creation initiatives.",
          "Candlestick draws on the underlying principles of global ESG initiatives such as the TCFD, UN PRI, and UN SDGs, and intends to gradually integrate ESG considerations into its investment process in a manner appropriate to its investment strategy and scale of operations.",
        ],
        investmentPrinciplesTitle: "Investment Principles",
        principles: [
          {
            title: "Environment",
            body: "Candlestick considers key environmental factors relevant to each business during investment review and post-investment management, including compliance with environmental laws and regulations, environmental risks, energy use, and waste management.",
          },
          {
            title: "Social",
            body: "Candlestick considers relationships with key stakeholders, including employees, customers, and business partners, as well as occupational health and safety, human rights, data privacy, fair business practices, and social responsibility.",
          },
          {
            title: "Governance",
            body: "Candlestick reviews board and key decision-making structures, internal controls, financial reporting transparency, the management of conflicts of interest, and protections for shareholders and investors.",
          },
        ],
        actionTitle: "Implementation Framework",
        actionHeaders: ["Category", "Direction"],
        actionRows: [
          ["Investment Review", "During due diligence, Candlestick assesses material ESG risks alongside financial considerations and identifies any significant environmental, social, or governance issues relevant to the target company’s business characteristics."],
          ["Investment Decision", "During investment committee review, Candlestick considers key ESG risks and potential areas for improvement alongside the target company’s growth potential, profitability, and exit prospects."],
          ["Post-Investment Management", "Candlestick maintains regular and as-needed communication with portfolio company management and discusses key improvement priorities, including internal controls, financial management, corporate governance, compliance, human resources, and organizational management."],
      ...
      ko: {
        ...
        esgTitle: "캔들스틱의 ESG",
        esgLead: [
          "주식회사 캔들스틱(이하 “캔들스틱” 또는 “회사”)은 투자대상회사의 지속가능한 성장과 장기적인 기업가치 제고가 투자자의 이익과 밀접하게 연결되어 있음을 인식하고 있습니다. 이에 따라 회사는 투자 검토, 투자 의사결정, 사후관리 및 회수에 이르는 전 과정에서 환경(Environment), 사회(Social), 지배구조(Governance) 요소를 고려하고자 노력합니다.",
          "캔들스틱은 단순한 재무적 성과뿐만 아니라 투자대상회사의 경영 투명성, 내부통제 수준, 이해관계자와의 관계, 법규 준수, 환경·사회적 리스크 등을 종합적으로 검토합니다. 또한 투자 이후에는 투자대상회사의 성장 단계와 사업 특성에 맞는 개선 과제를 함께 논의하고, 필요한 경우 외부 전문가와의 협업을 통해 실질적인 기업가치 제고 방안을 모색합니다.",
          "캔들스틱은 TCFD, UN PRI, UN SDGs 등 글로벌 ESG 이니셔티브의 기본 취지를 참고하고, 회사의 투자전략과 운용 규모에 적합한 방식으로 ESG 요소를 투자 과정에 점진적으로 내재화해 나가겠습니다.",
        ],
        investmentPrinciplesTitle: "투자원칙",
        principles: [
          { title: "환경", body: "캔들스틱은 투자 검토 및 사후관리 과정에서 투자대상회사의 환경 관련 법규 준수 여부, 환경 리스크, 에너지 사용, 폐기물 관리 등 각 사업의 특성에 따른 주요 환경 요소를 고려합니다." },
          { title: "사회", body: "캔들스틱은 투자대상회사의 임직원, 고객, 협력사 등 주요 이해관계자와의 관계를 비롯하여 산업안전, 인권, 개인정보 보호, 공정거래 및 사회적 책임과 관련된 요소를 고려합니다." },
          { title: "지배구조", body: "캔들스틱은 투자대상회사의 이사회 및 주요 의사결정 구조, 내부통제, 회계 투명성, 이해상충 관리, 주주 및 투자자 보호 장치 등을 검토합니다." },
        ],
        actionTitle: "세부 실행 방안",
        actionHeaders: ["구분", "실행 방향"],
        actionRows: [
          ["투자 검토", "실사 과정에서 재무적 요소와 함께 주요 ESG 리스크를 점검하고, 투자대상회사의 사업 특성상 중대한 환경·사회·지배구조 관련 이슈가 있는지 확인합니다."],
          ["투자 의사결정", "투자심의 과정에서 대상 회사의 성장성, 수익성, 회수 가능성과 함께 주요 ESG 리스크 및 개선 가능성을 검토합니다."],
          ["투자 이후 관리", "투자대상회사의 경영진과 정기적·비정기적으로 소통하며, 필요시 내부통제, 재무관리, 지배구조, 컴플라이언스, 인력 및 조직 운영 등 주요 개선 과제를 논의합니다."],
